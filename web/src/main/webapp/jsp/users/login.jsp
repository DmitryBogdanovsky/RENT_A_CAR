                                    ...
                                    <div class="section text-center">
                                        ...
                                        <form method="POST" action="${pageContext.request.contextPath}/login">
                                            <div class="form-group" >
                                                <input required type="email" name="username" class="form-style"
                                            ...
                                            <div class="form-group mt-2">
                                                ...
                                                <button class="btn mt-4-primary btn-lg" type="submit">Log In</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="center-wrap">
                                    <div class="section text-center">
                                      ...
                                      <form method="post" action="${pageContext.request.contextPath}/registration.action"  modelAttribute="user">
                                        ...
                                        <div class="form-group mt-3">
                                            <input required type="email" name="email" class="form-style" placeholder="Your Email"
                                                   id="email" autocomplete="on">
                                            <i class="input-icon uil uil-at"></i>
                                        </div>
                                        <div class="form-group mt-3">
                                            <input required type="password" name="password" class="form-style"
                                                   placeholder="Your Password" id="regPassword" autocomplete="off">
                                            <i class="input-icon uil uil-lock-alt"></i>
                                        </div>
