        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse"  id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/car-list.view">Choose a car</a>
                    </li>
                    ...
                    <security:authorize access="hasRole('ROLE_ADMIN')">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="${pageContext.request.contextPath}/brand-add.view">Add brand</a>
                                </li>
                                <li>
              ...
              <ul class="navbar-nav mb-2 mb-lg-0">
                    <li class="d-flex nav-item dropdown">
                        ...
                        <security:authorize access="isAuthenticated()">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="${pageContext.request.contextPath}/user-profile/{userId}.view">
                                    View Personal profile</a>
                                </li>
                                <li><a class="dropdown-item" href="${pageContext.request.contextPath}/edit-userProfile/{userId}.view">
                                    Edit Profile</a>
                                </li>
